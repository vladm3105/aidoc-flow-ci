...
jobs:
  call:
    uses: vladm3105/aidoc-flow-ci/.github/workflows/markdown-lint.yml@ci/v2.11.0
    with:
...
jobs:
  codeql:
    uses: vladm3105/aidoc-flow-ci/.github/workflows/codeql.yml@ci/v2.11.0
    with:
...
jobs:
  internal:
    uses: vladm3105/aidoc-flow-ci/.github/workflows/links.yml@ci/v2.11.0
    with:
      mode: internal
      paths: docs
```
