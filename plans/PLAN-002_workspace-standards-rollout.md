...
> **PRE-`ci/v3` — OPEN WORK REMAINS.** This plan targets `ci/v1.6.0`, so it
> is **not part of the `ci@v3` line** — but it is **not closed**: per-tier
> consumer rollout is ongoing per its §5.5. **Retarget to the v3 line before
