...
| **Reviewer App + LiteLLM secrets** `APP_REVIEWER_1_ID/KEY`, `LITELLM_BASE_URL`, `LITELLM_API_KEY` | ai-review needs the reviewer App and a reachable LiteLLM proxy | See [`docs/REVIEWER_APP_ONBOARDING.md`](docs/REVIEWER_APP_ONBOARDING.md) |
